...
const Navbar = () => {
  return (
    ...
    <div className='flex justify-between items-center p-3 gap-4 lg:flex-row flex-row  h-[70px]  max-w-[1180px] lg:gap-5   mx-auto'>
      <div className='flex items-center rounded-lg gap-2 '>
        {/* <img src="/public/port.png" alt="portfolio" className='h-14' /> */}
        <img class="w-10  p-1 rounded-full lg:h-[40px] ring-2 ring-gray-300 dark:ring-gray-500" src="/public/port.png " alt="Bordered avatar"/>
